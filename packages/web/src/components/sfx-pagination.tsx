...
interface SfxPaginationProps {
  page: number;
  pageCount: number;
}

export function SfxPagination({ page, pageCount }: SfxPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between px-4.5 py-3 bg-[#fafbfc] border border-[#e6ebf1] rounded-xl mt-3.5">
